 ...
 */
namespace Beacon\Catalog\Ui\DataProvider\Product\Form\Modifier;
 ...
 * @since 101.0.0
 */
class CustomDetails extends AbstractModifier
{
    const DATA_SCOPE = '';
    const DATA_SCOPE_RELATED = 'custom_details';
    const GROUP_RELATED = 'custom_details';
            ...
            [
                static::GROUP_RELATED => [
                    ...
                    'arguments' => [
                        'data' => [
                            'config' => [
                                'label' => __('Related Products Customization'),
                                'collapsible' => true,
    ...
    protected function getCustomerGroups()
    {
        ...
        $emptyItem = [
            0 => [
                'label' => __('Please Select a Customer group'),
                'value' => 0
            ]
        ];
